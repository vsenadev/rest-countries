...
export interface combinetedInterface extends CardsProps, IStyle {}

export default function Cards(props: combinetedInterface){
    return (
            ...
            <section className={styles.container__section}>
                {
                    props.data.map((element: ICountries) => {
                        return(
                            <div key={element.name.common} className={`${props.darkMode ? styles.container__section_div_dark_card : styles.container__section_div}`}>
